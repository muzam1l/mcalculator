...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 45728,
    DYNAMIC_BASE = 5288608,
    DYNAMICTOP_PTR = 45568;
...
var asmGlobalArg = {};
var asmLibraryArg = { "__assert_fail": ___assert_fail, "__cxa_allocate_exception": ___cxa_allocate_exception, "__cxa_atexit": ___cxa_atexit, "__cxa_throw": ___cxa_throw, "__handle_stack_overflow": ___handle_stack_overflow, "__map_file": ___map_file, "__syscall3": ___syscall3, "__syscall5": ___syscall5, "__syscall91": ___syscall91, "abort": _abort, "abs": _abs, "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_resize_heap": _emscripten_resize_heap, "environ_get": _environ_get, "environ_sizes_get": _environ_sizes_get, "fd_close": _fd_close, "fd_read": _fd_read, "fd_seek": _fd_seek, "fd_write": _fd_write, "init": init, "memory": wasmMemory, "setEx": setEx, "setHs": setHs, "setMem": setMem, "setPr": setPr, "setTempRet0": _setTempRet0, "strftime_l": _strftime_l, "table": wasmTable, "upMem": upMem };
var asm = createWasm();
Module["asm"] = asm;
/** @type {function(...*):?} */
...
/** @type {function(...*):?} */
var ___em_js__init = Module["___em_js__init"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__em_js__init"].apply(null, arguments)
};
...
/** @type {function(...*):?} */
var _clearHs = Module["_clearHs"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["clearHs"].apply(null, arguments)
};

/** @type {function(...*):?} */
var _clearMem = Module["_clearMem"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["clearMem"].apply(null, arguments)
};

/** @type {function(...*):?} */
var _memComm = Module["_memComm"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["memComm"].apply(null, arguments)
};
...
/** @type {function(...*):?} */
var ___em_js__setPr = Module["___em_js__setPr"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__em_js__setPr"].apply(null, arguments)
};

/** @type {function(...*):?} */
var ___em_js__setEx = Module["___em_js__setEx"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__em_js__setEx"].apply(null, arguments)
};

/** @type {function(...*):?} */
var ___em_js__setHs = Module["___em_js__setHs"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__em_js__setHs"].apply(null, arguments)
};

/** @type {function(...*):?} */
var ___em_js__setMem = Module["___em_js__setMem"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__em_js__setMem"].apply(null, arguments)
};

/** @type {function(...*):?} */
var ___em_js__upMem = Module["___em_js__upMem"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__em_js__upMem"].apply(null, arguments)
};
